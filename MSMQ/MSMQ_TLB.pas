...
// File generated on 03/02/2017 16:33:31 from Type Library described below.
...
// Help String      : Fornece um método de pesquisa que é usado para localizar filas públicas.
...
// Help String      : Fornece propriedades que definem a mensagem e os métodos para enviá-la para uma ou mais filas.
...
// Help String      : Fornece as propriedades de uma instância aberta de uma fila e métodos para exibir ou recuperar mensagens dela.
...
// Help String      : Fornece eventos que são usados para ler mensagens de forma assíncrona.
...
// Help String      : Fornece as propriedades que definem uma fila e métodos para criar, abrir e excluir a fila e configurar e recuperar suas propriedades.
...
// Help String      : Fornece métodos para enumerar os elementos de uma coleção de filas públicas retornada por MSMQQuery.LookupQueue.
...
// Help String      : Fornece propriedades que especificam um objeto de transação externo subjacente MS DTC ou um objeto de transação interno e os métodos padrão ITransaction Commit e Abort.
...
// Help String      : Fornece um método que inicia uma nova transação externa MS DTC e retorna um objeto de transação MSMQ que representa o novo objeto de transação subjacente.
...
// Help String      : Fornece um método que inicia uma nova transação interna e retorna um objeto de transação MSMQ que representa o novo objeto de transação subjacente.
...
begin
  case DispID of
   ...
   0: if Assigned(FOnArrived) then
            FOnArrived(Self, Params[1] {Integer}, Params[0] {const IDispatch});
   1: if Assigned(FOnArrivedError) then
            FOnArrivedError(Self, Params[2] {Integer}, Params[1] {Integer}, Params[0] {const IDispatch});
  end; {case DispID}
end;
